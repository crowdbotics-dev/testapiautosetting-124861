...
## Project Structure
    ...
    ├── testapiautosetting_124861  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124861`
...
2. Clone this repo and `cd testapiautosetting_124861`
